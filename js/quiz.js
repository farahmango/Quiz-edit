...
function getJson(path){
    ...
    console.log(data[str])
      loadData()
    var resultHistory=[]
    // this function to store in local storage 
    ...
    function getUserAnswer(){
        ...
        console.log(firstAnswer)
         new HistoryAnswer(
            // store question ,user answer ,correct answer 
            data[str][currentQuiz].question,firstAnswer,data[str][currentQuiz].correct)
            return firstAnswer}
